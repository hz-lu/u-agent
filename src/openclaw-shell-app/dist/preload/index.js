...
electron.contextBridge.exposeInMainWorld("uclaw", {
  ...
  ipcListChatSkills: (options) => electron.ipcRenderer.invoke("list-chat-skills", options),
  // 鍚敤/绂佺敤 skill
  ...
  gatewayChatHistory: (payload) => electron.ipcRenderer.invoke("gateway-chat-history", payload),
  // default port
